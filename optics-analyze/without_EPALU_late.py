...
late_OPA_list = [late_mrr, late_dc, late_psi*4., late_adc1, late_logicgate]
...
ax.broken_barh([(0, late_bf16a)], (20, 9), facecolors='#00cc00', label='10bitAdder')
...
# p_OPAの描画
start = 0
colors = ['#ffff33', 'y', '#bb9900','#ff0000','#888888']
